<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@page import ="com.entity.Student,java.util.ArrayList" %>
			...
			<div class="row">
				<div class="col-lg-12y"style="background: linear-gradient(57deg, #00C6A7 , #1E4D92 )">
					<div class=container-fluid>
					 	<div class="row">
							<table class="table" width="95%" style="color:black" border="2">
								...
								<thead>
									...
									<th>E-Mail ID</th><th>Course</th></tr>
								</thead>
									<c:forEach var="al" items="${requestScope.al}">
								 		<tr class="success">
											...
											<td> <c:out value="${al.getCourse()}"/></td>
					 	...
					 	</div> <center><a href="Student.jsp"><h1 style="color:white">Back</h1></a></center>
					 </div>
